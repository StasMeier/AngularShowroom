...
import {ForceDirectedGraph, SimpleLineGraph} from '../models';
...
export class D3LineComponent implements OnInit, AfterViewInit {
  @Input('nodes') nodes;
  @Input('links') links;
  @Input() width = 1000;
  @Input() height = 600;
  ...
  ngOnInit() {
    ...
    this.graph = this.d3Service.getSimpleLineGraph(this.nodes, this.options);
